...
namespace MatchingGame
{
    public partial class MultiGameForm : Form
    {
        ...
        private void MultiGameForm_Load(object sender, EventArgs e)
        {
            ...
            Fonts.AddFontFile("./Resources/KAMIKZOM.ttf");

            Font f = new Font(Fonts.Families[0], 24f);

            
            this.ClientSize = new Size(1200, 700);
            background = new GameImage(Properties.Resources.mback, 400, 700);
            backGround = background.ResizeBitmap;

            pan = new GameImage(Properties.Resources.kurbi_pan, panWid, pandHei);

            kirby1 = new AnimationImage(Properties.Resources.kirby_run1, 8, 20.0f, 600, 150);
            kirby2 = new AnimationImage(Properties.Resources.kirby_run2, 8, 20.0f, 600, 150);

            kirbyS1 = new AnimationImage(Properties.Resources.kirby1, 8, 8.0f, 600, 150);
            kirbyS2 = new AnimationImage(Properties.Resources.kirby2, 8, 8.0f, 600, 150);
        ...
        public void StartGame()
        {
            ...
            for (int i = 0; i < game.Length; i++, check = false)
            {
                ...
                back = new GameImage(Properties.Resources.back, 80, 100);
        ...
        public void ImageChange(PictureBox pic, int value)
        {
            ...
            {
                case 0:
                    bitmap = new GameImage(Properties.Resources.spade_a, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 1:
                    bitmap = new GameImage(Properties.Resources.spade_2, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 2:
                    bitmap = new GameImage(Properties.Resources.spade_3, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 3:
                    bitmap = new GameImage(Properties.Resources.spade_4, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 4:
                    bitmap = new GameImage(Properties.Resources.spade_5, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 5:
                    bitmap = new GameImage(Properties.Resources.spade_6, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 6:
                    bitmap = new GameImage(Properties.Resources.spade_7, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 7:
                    bitmap = new GameImage(Properties.Resources.spade_8, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 8:
                    bitmap = new GameImage(Properties.Resources.spade_9, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 9:
                    bitmap = new GameImage(Properties.Resources.spade_10, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 10:
                    bitmap = new GameImage(Properties.Resources.spade_j, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 11:
                    bitmap = new GameImage(Properties.Resources.spade_q, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 12:
                    bitmap = new GameImage(Properties.Resources.spade_k, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 13:
                    bitmap = new GameImage(Properties.Resources.heart_a, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 14:
                    bitmap = new GameImage(Properties.Resources.heart_2, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 15:
                    bitmap = new GameImage(Properties.Resources.heart_3, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 16:
                    bitmap = new GameImage(Properties.Resources.heart_4, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 17:
                    bitmap = new GameImage(Properties.Resources.heart_5, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 18:
                    bitmap = new GameImage(Properties.Resources.heart_6, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 19:
                    bitmap = new GameImage(Properties.Resources.heart_7, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 20:
                    bitmap = new GameImage(Properties.Resources.heart_8, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 21:
                    bitmap = new GameImage(Properties.Resources.heart_9, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 22:
                    bitmap = new GameImage(Properties.Resources.heart_10, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 23:
                    bitmap = new GameImage(Properties.Resources.heart_j, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 24:
                    bitmap = new GameImage(Properties.Resources.heart_q, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;

                case 25:
                    bitmap = new GameImage(Properties.Resources.heart_k, 80, 100);
                    pic.Image = bitmap.ResizeBitmap;
                    break;
