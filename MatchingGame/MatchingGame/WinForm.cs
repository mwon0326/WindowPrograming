...
namespace MatchingGame
{
    public partial class WinForm : Form
    {
        ...
        private void WinForm_Load(object sender, EventArgs e)
        {
            ...
            quit = new GameImage(Properties.Resources.quit, 200, 50);
            quitS = new GameImage(Properties.Resources.quit_s, 200, 50);
            back = new GameImage(Properties.Resources.background, 400, 500);
